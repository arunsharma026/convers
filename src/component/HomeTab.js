                        ...
                        <div className="col-md-6 col-sm-6 col-xs-12">
                           <div className="machine-text">
                              ...
                              <p>Dummy text is also used to demonstrate the appearance of different typefaces
                                 and layouts, and in general the content of dummy text is nonsensical. used
                                 to demonstrate the appearance of different typefaces and layouts, and in
                     ...
                     <div className="single-machine row">
                        ...
                        <div className="col-md-6 col-sm-6 col-xs-12">
                           <div className="machine-text">
                              ...
                              <p>And in general the content of dummy text is nonsensical. used to demonstrate
                                 the appearance of different typefaces and layouts, and in general the
                                 content of dummy text is nonsensical. Dummy text is also used to demonstrate
                                 the appearance of different typefaces and layouts
                              </p>
                              <ul>
                                 <li><a href="#">Innovation idea latest business tecnology</a></li>
                                 <li><a href="#">Digital content marketing online clients plateform</a></li>
                     ...
                     <div className="single-machine row">
                        ...
                        <div className="col-md-6 col-sm-6 col-xs-12">
                           <div className="machine-text">
                              ...
                              <p>Used to demonstrate the appearance of different typefaces and layouts, and in
                                 general the content of dummy text is nonsensical. text is also used to
                        ...
                        <div className="col-md-6 col-sm-6 col-xs-12">
                           <div className="machine-text">
                              ...
                              <p>Dummy text is also used. used to demonstrate the appearance of different
                                 ...
                                 nonsensica to demonstrate the appearance of different typefaces and layouts,
